...
const NewPage = (): JSX.Element => {
  ...
  const createTask = async (task: Task) =>
    await fetch("https://apigithubnew-final.azurewebsites.net/itassets/", {
      method: "POST",
  ...
  const updateTask = async (id: string, task: Task) =>
    await fetch("https://apigithubnew-final.azurewebsites.net/itassets/" + id, {
      method: "PUT",
      body: JSON.stringify(task),
      headers: {
        "Content-Type": "application/json",
  ...
  const loadTask = async (id: string) => {
    const res = await fetch("https://apigithubnew-final.azurewebsites.net/itassets/" + id);
  ...
  return (
    <Layout>
      ...
      <Confirm
        ...
        content={`Are you sure you want to delete It asset ${router.query.id}`}
        open={openConfirm}
